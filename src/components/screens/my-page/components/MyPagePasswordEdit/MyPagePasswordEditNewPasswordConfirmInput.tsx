...
interface MyPagePasswordEditNewPasswordConfirmInputProps {}

const MyPagePasswordEditNewPasswordConfirmInput: FC<
    MyPagePasswordEditNewPasswordConfirmInputProps
> = () => {
    const {
        register,
        control,
...
export default MyPagePasswordEditNewPasswordConfirmInput;
